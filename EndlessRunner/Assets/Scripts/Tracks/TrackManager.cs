...
public class TrackManager : MonoBehaviour
{
    ...
    [Header("Tutorial")]
    public ErThemeData tutorialThemeData;
    ...
    public ErThemeData currentTheme { get { return m_CurrentThemeData; } }
    ...
    protected ErThemeData m_CurrentThemeData;
...
//"level" in our game are milestone the player have to reach : one every 300m
    ...
    {
        Debug.Log("SpawnFromAssetReference::reference=" + reference.SubObjectName + " ; segment=" + segment.name + " ; posIndex=" + posIndex);
