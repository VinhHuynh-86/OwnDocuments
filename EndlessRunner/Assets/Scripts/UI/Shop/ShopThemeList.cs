...
public class ShopThemeList : ShopList
{
    public override void Populate()
    {
        ...
        foreach (KeyValuePair<string, ErThemeData> pair in ThemeDatabase.dictionnary)
        {
            ErThemeData theme = pair.Value;
            if (theme != null)
            {
	...
	protected void RefreshButton(ShopItemListItem itm, ErThemeData theme)
	{
