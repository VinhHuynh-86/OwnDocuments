...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonUserControl : NetworkedBehaviour
    {
        ...
        private void OnPositionUpdate(uint clientId, byte[] data)
        {
            ...
            ComputeMovement();
            transform.position = new Vector3(transform.position.x + m_Speed * m_Horizontal * Time.deltaTime, transform.position.y, transform.position.z + m_Speed * m_Vertical * Time.deltaTime);
