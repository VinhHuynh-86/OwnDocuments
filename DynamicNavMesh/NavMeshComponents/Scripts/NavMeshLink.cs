...
namespace UnityEngine.AI
{
    ...
    public class NavMeshLink : MonoBehaviour
    {
        ...
        public Vector3 startPoint { get { return m_StartPoint.position; } set { m_StartPoint.position = value; UpdateLink(); } }

        [SerializeField]
        Transform m_EndPoint;
        public Vector3 endPoint { get { return m_EndPoint.position; } set { m_EndPoint.position = value; UpdateLink(); } }
        ...
        void AddLink()
        {
            ...
            link.startPosition = m_StartPoint.position;
            link.endPosition = m_EndPoint.position;
            link.width = m_Width;
